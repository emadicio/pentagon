...
/*
 * Prevents the first person camera to be moved beyond the limits of the pentagon bounding box
 */
...
/*
 * Prevents the object from being dragged beyond the limits of the pentagon bounding box
 */
